...
def write_info(info_dict:dict)-> str :
    ...
    for title in info_dict["url"]:
        points_string +=  latex_add_href(url = info_dict['url'][title] , title= title) +  INFO_SEP
    ...
    replacements = {"[[points]]" : points_string,
                    "[[name]]"   : name}
...
def write_generic_entry( title:str,  year:str, org:str="", points:dict=None )-> str:
